/**
 * SP.nl MUI theme preset (ThemeOptions)
 *
 * Derived from sp-styleguide.html. Intended for localStorage via saveCustomTheme(spThemeOptions)
 * (Setup Theme) or pplySpThemePreset() in themeLoader. Not the app default; see defaultTheme.ts.
 */
...
export const spThemeOptions: ThemeOptions = {
  palette: {
    mode: "light",
    primary: {
...
export const spTheme = createTheme(spThemeOptions);
